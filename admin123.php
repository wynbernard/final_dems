	...
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="idpRegistrationForm" method="POST" action="../action/registration_staff.php" enctype="multipart/form-data">
					<div class="alert alert-info mb-3">
						...
						if ($selectedLocationId) {
							...
							if ($fallbackEvacId) {
								$stmt = $conn->prepare("SELECT evac_loc_table.name FROM admin_table LEFT JOIN evac_loc_table ON admin_table.evac_loc_id = evac_loc_table.evac_loc_id WHERE evac_loc_id = ?");
